                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-line mb-2">
                                ...
                                <input type="text" class="form-control" name="nama_petugas" id="nama_petugas_edit" required placeholder="Masukan nama petugas">
                            </div>
                            <div class="form-line mb-2">
                                ...
                                <select name="unit" id="unit_edit" class="form-control">
